...
const ChairmanMessage = () => {
  ...
  <div className="image-section">
    ...
    <h3 className="chairman-name">এম.ডি. কবির আহমেদ</h3>
<p className="chairman-position">সহকারী প্রধান শিক্ষক</p>
  ...
  <div className="message-section">
    <h2 className="message-heading">সহকারী প্রধান শিক্ষক</h2>
